...
do_excel = HandleExcel(TEST_DATAS_FILE_PATH, "userinfo2")
...
class UserInfo(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # data = {"mobile": "17621620970", "captcha": "0000",  "password": "123456", "device": "android", "language": "ch", "area_code": "+86",
        #         "device_no": "test", "phone_type": "9500", "system": "28", "idfa": "test"}

        data = {"mobile": mobile, "captcha": "0000", "device": "android", "language": "ch", "area_code": "+86",
                "device_no": "test", "phone_type": "9500", "system": "28", "idfa": "test"}
