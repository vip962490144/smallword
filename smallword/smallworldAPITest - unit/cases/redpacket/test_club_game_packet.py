...
class ClubGamePacket(unittest.TestCase):
    """
    俱乐部冒险游戏红包
    """
    @classmethod
    ...
    def test_case_01(self):
        ...
        data_list = {"club_id": "5109", "type": 1, "user_num": "10",
                     "total_money": "100", "adventure_conetent": "美女才可以领"}
        # data_list = {"club_id": "5109", "type": 1, "user_num": "3",
        #              "total_money": "100", "adventure_conetent": "美女才可以领"}
        redpacket_actual = RedpacketBase().club_adventure_game(a_login_token, data_list)
        ...
        # 奖池
        guess_diamond_num = int(guess_after_diamond) - int(guess_befoer_diamond) + int(guess_diamond)
        # 断言，判断前后的差值
        try:
            # 钻石
